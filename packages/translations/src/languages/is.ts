...
export const isTranslations = {
  authentication: {
    account: 'Reikningur',
    accountOfCurrentUser: 'Reikningur notanda',
    accountVerified: 'Reikningur verified successfully.',
  ...
  error: {
    ...
    autosaving: 'Villa kom upp við sjálfvirka vistun á efni.',
    ...
    incorrectCollection: 'Röng efnistegund',
    ...
    loadingDocument: 'Villa kom upp við að sækja efni með ID: {{id}}.',
    ...
    missingIDOfDocument: 'Vantar ID fyrir efni til að uppfæra.',
    ...
    previewing: 'Villa kom upp við að forskoða efni.',
    ...
    unPublishingDocument: 'Villa kom upp við að taka efnið úr birtingu.',
    ...
    usernameOrPasswordIncorrect: 'Notandanafn eða lykilorð er rangt skráð.',
  ...
  fields: {
    ...
    chooseBetweenCustomTextOrDocument:
      'Veldu á milli að slá inn sérsniðna slóð eða tengja við annað efni.',
    chooseDocumentToLink: 'Veldu efni til að tengja við',
  ...
  general: {
    ...
    allCollections: 'Allar efnistegundir',
    and: 'Og',
    anotherUser: 'Annar notandi',
    anotherUserTakenOver: 'Annar notandi hefur tekið yfir skráningu þessa efnis.',
    ...
    confirmReindexAll: 'Reindexa allar efnistegundir?',
    confirmReindexDescription:
      'Þetta mun eyða núverandi indexe og reindexa efni í {{collections}} efnistegundum.',
    confirmReindexDescriptionAll:
      'Þetta mun eyða núverandi indexeum og reindexa efni í öllum efnistegundum.',
    copied: 'Afritað',
    copy: 'Afrita',
    copying: 'Afrita',
    ...
    createdAt: 'Skráð kl.',
    createNew: 'Skrá nýtt',
    createNewLabel: 'Skrá nýtt: {{label}}',
    creating: 'Skrái',
    creatingNewLabel: 'Skrái nýtt {{label}}',
    currentlyEditing:
      'er að vinna í þessu efni. Ef þú tekur yfir, mun viðkomandi ekki geta haldið áfram að vinna í efni, og gætu glatað óvistuðum breytingum.',
    custom: 'Sérsniðin',
    dark: 'Dökkt',
    dashboard: 'Yfirlit',
    delete: 'Eyða',
    ...
    previous: 'Fyrri',
    reindex: 'Reindexa',
    reindexingAll: 'Reindexa allt {{collections}}.',
    remove: 'Fjarlægja',
    reset: 'Reset',
    row: 'Röð',
    rows: 'Raðir',
    ...
    submitting: 'Sendi...',
    success: 'Tókst',
    successfullyCreated: '{{label}} var búið til.',
  ...
  upload: {
    ...
    selectCollectionToBrowse: 'Veldu efnistegund til að skoða',
  ...
  version: {
    type: 'Tegund',
    aboutToPublishSelection: 'Þú ert að fara að gefa út allar {{label}} í vali. Ertu viss?',
    ...
    aboutToRevertToPublished:
      'Þú munt endursetja breytingar á þessu efni í útgefna stöðu. Ertu viss?',
    aboutToUnpublish: 'Þú munt taka þetta efni úr birtingu. Ertu viss?',
    aboutToUnpublishSelection: 'Þú munt taka úr birtingu allt {{label}} í vali. Ertu viss?',
    ...
    currentDocumentStatus: 'Núverandi {{docStatus}} efni',
